...
<div
    x-data="createDialog()"
    @toggle-create-modal.window="createModal = !createModal"
>
  <!-- overlay -->
  <form
      class="z-10 overflow-y-auto top-0 w-full left-0"
      id="create" method="post" action="./funcs/tambah.php"
      x-show="isOpenCreateModal()"
      :class="{ 'create-history-modal': isOpenCreateModal() }"
  >
    <!-- dialog -->
    <div
      ...
      <div
        ...
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          ...
          <h4 class="mr-3 text-black max-w-none text-semibold mb-2 pb-2 border-b-2">
            ...
            <button type="button" class="z-50 cursor-pointer float-right" @click="closeCreateModal"
            >
        ...
        <div class="bg-gray-200 px-4 py-3 text-right">
          <button type="button" class="py-2 px-4 bg-gray-500 text-white rounded hover:bg-gray-700 mr-2" @click="closeCreateModal"
