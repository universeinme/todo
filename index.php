...
<nav class="flex justify-around py-4 bg-white/80
    ...
    <div class="flex items-center space-x-5">
        ...
        <a class="flex text-gray-600 hover:text-blue-500
                   cursor-pointer transition-colors duration-300" onclick="toggleDaftar()">
        ...
        <!-- Login -->
        <a class="flex text-gray-600 hover:text-blue-500
                   cursor-pointer transition-colors duration-300" onclick="toggleLogin()">
    ...
    <div class="flex flex-col justify-end items-end fixed select-none sticky">
        <div class="absolute flex items-center justify-center align-middle top-8">
            <button onclick="toggleCreate()"
                    class="drop-shadow-md bg-white h-10 w-20 rounded-full align-middle font-semibold">Create
            </button>
        </div>
    </div>
</main>
    ...
    <div class="flex items-center justify-center min-height-100vh pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <input type="text" class="w-full bg-gray-100 p-2 mt-2 mb-3" id="inputUsername" name="username"/>

                <label for="inputEmail">Email</label>
                <input type="email" class="w-full bg-gray-100 p-2 mt-2 mb-3" id="inputEmail" name="email"/>

                <label for="inputPassword">Password</label>
                <input type="password" class="w-full bg-gray-100 p-2 mt-2 mb-3" id="inputPassword" name="password"/>
            </div>

            <div class="bg-gray-200 px-4 py-3 text-right">
                <button type="button" class="py-2 px-4 bg-gray-500 text-white rounded hover:bg-gray-700 mr-2"
                        onclick="toggleDaftar()"><i class="fas fa-times"></i> Cancel
                </button>
    ...
    <div class="flex items-center justify-center min-height-100vh pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <input type="password" class="w-full bg-gray-100 p-2 mt-2 mb-3" id="password" name="password" value="" required/>
            </div>

            <div class="bg-gray-200 px-4 py-3 text-right">

                <button type="button" class="py-2 px-4 bg-gray-500 text-white rounded hover:bg-gray-700 mr-2"
                        onclick="toggleLogin()"><i class="fas fa-times"></i> Cancel
                </button>
    ...
    <div class="flex items-center justify-center min-height-100vh pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <textarea rows="1" class="w-full bg-gray-100 p-2 mt-2 mb-3 text-sm rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" id="inputJudul" name="inputJudul"
                       placeholder="Judul"/></textarea>

                <!--deskripsi-->
                <label for="inputDeskripsi">Deskripsi</label>
                <textarea type="textarea" rows="2" class="block w-full bg-gray-100 p-2 mt-2 mb-3 text-sm rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" id="inputDeskripsi"
                          name="inputDeskripsi" placeholder="Deskripsi"></textarea>
            </div>
            <div class="bg-gray-200 px-4 py-3 text-right">
                <button type="button" class="py-2 px-4 bg-gray-500 text-white rounded hover:bg-gray-700 mr-2"
                        onclick="toggleCreate()"><i class="fas fa-times"></i> Cancel
                </button>
                <button type="submit" class="py-2 px-4 bg-blue-500 text-white rounded hover:bg-blue-700 mr-2">
